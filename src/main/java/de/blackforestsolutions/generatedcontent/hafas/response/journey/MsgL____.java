...
public class MsgL____ implements Serializable
{
    ...
    private final static long serialVersionUID = 8495647416529150783L;
    ...
    @JsonProperty("txtC")
    public TxtC__ getTxtC() {
        return txtC;
    }

    @JsonProperty("txtC")
    public void setTxtC(TxtC__ txtC) {
        this.txtC = txtC;
    }
