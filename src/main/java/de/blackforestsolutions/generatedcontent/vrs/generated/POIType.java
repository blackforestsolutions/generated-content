 ...
 * Ein POI
 * 
 * <p>Java-Klasse für POIType complex type.
 * 
...
@XmlType(name = "POIType", propOrder = {
    "nr",
    "name",
    "coordinate",
    "group",
...
public class POIType {
    ...
    protected List<POIType.Name> name;
     ...
     * 
     */
    public List<POIType.Name> getName() {
        if (name == null) {
            name = new ArrayList<POIType.Name>();
        }
        return this.name;
    }
