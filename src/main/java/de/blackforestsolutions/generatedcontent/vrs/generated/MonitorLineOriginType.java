...
/**
 * <p>Java-Klasse für MonitorLineOriginType complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="MonitorLineOriginType"&gt;
 *   &lt;simpleContent&gt;
...
@XmlType(name = "MonitorLineOriginType", propOrder = {
    "value"
})
public class MonitorLineOriginType {
