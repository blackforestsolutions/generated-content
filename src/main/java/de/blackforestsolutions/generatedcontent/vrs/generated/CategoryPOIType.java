 ...
 * Ein POI-Kategorie
 * 
 * <p>Java-Klasse für CategoryPOIType complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="CategoryPOIType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "CategoryPOIType", propOrder = {
    "name",
    "group",
    "infoMessages"
})
public class CategoryPOIType {

    @XmlElement(name = "Name", required = true)
    protected List<CategoryPOIType.Name> name;
     ...
     * {@link CategoryPOIType.Name }
     * 
     * 
     */
    public List<CategoryPOIType.Name> getName() {
        if (name == null) {
            name = new ArrayList<CategoryPOIType.Name>();
        }
        return this.name;
    }
